...
/*
 * This class produces common file open and file save dialogs for normal operation and 
 * I have changed them to JavaFX file chooser, save/ load.
 */
public abstract class FileService
{
   ...
   private static class JFileChooserService extends FileService
   {
      ...
      {
    	 System.out.println("Chris - Open - Test");
         //fileChooser.resetChoosableFileFilters();
         //fileChooser.setFileFilter(filter);
    	 FileChooser.ExtensionFilter extFilter = 
                 new FileChooser.ExtensionFilter("TEXT files (*.XML)", "*.XML");
      ...
      {
    	  System.out.println("Chris - Save - Test");
         //fileChooser.resetChoosableFileFilters();
         //fileChooser.setFileFilter(filter);
    	  FileChooser.ExtensionFilter extFilter = 
                  new FileChooser.ExtensionFilter("TEXT files (*.XML)", "*.XML");
         ...
         if (defaultFile != null)
         {
            ...
            fileChooser.setInitialDirectory(new File(""));
         File response = fileChooser.showSaveDialog(null);         
         if (response == null)
         {
        	//add extension XML
...
//            DialogResponse result = Dialogs.showConfirmDialog(
//                  null,
