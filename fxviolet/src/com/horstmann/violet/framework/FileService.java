...
public abstract class FileService
{
    ...
    * @throws IOException
    */
   /*ublic abstract Save save(String defaultDirectory, String defaultFile, ExtensionFilter extensions,
   ...
   private static class JFileChooserService extends FileService
   {
      ...
      {
    	 System.out.println("Chris Test Open");
      ...
      {
    	  System.out.println("Chris Test Save");
         fileChooser.resetChoosableFileFilters();
         fileChooser.setFileFilter(filter);
         if (defaultDirectory == null)
